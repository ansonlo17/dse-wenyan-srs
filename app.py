...
SAMPLE_PACKS = [
    ("01_lunyu", "論仁、論孝、論君子", "01_論仁論孝論君子_原文.txt", "01_論仁論孝論君子_語譯.txt", "01_論仁論孝論君子_難詞.json"),
    ("02_yuwosuo", "魚我所欲也", "02_魚我所欲也_原文.txt", "02_魚我所欲也_語譯.txt", "02_魚我所欲也_難詞.json"),
    ("03_xiaoyaoyou", "逍遙遊（節錄）", "03_逍遙遊_原文.txt", "03_逍遙遊_語譯.txt", "03_逍遙遊_難詞.json"),
    ("04_quanxue", "勸學（節錄）", "04_勸學_原文.txt", "04_勸學_語譯.txt", "04_勸學_難詞.json"),
    ("05_lianpo", "廉頗藺相如列傳（節錄）", "05_廉頗藺相如列傳_原文.txt", "05_廉頗藺相如列傳_語譯.txt", "05_廉頗藺相如列傳_難詞.json"),
    ("06_chushi", "出師表", "06_出師表_原文.txt", "06_出師表_語譯.txt", "06_出師表_難詞.json"),
    ("07_shishuo", "師說", "07_師說_原文.txt", "07_師說_語譯.txt", "07_師說_難詞.json"),
    ("08_xishan", "始得西山宴遊記", "08_始得西山宴遊記_原文.txt", "08_始得西山宴遊記_語譯.txt", "08_始得西山宴遊記_難詞.json"),
    ("09_yueyang", "岳陽樓記", "09_岳陽樓記_原文.txt", "09_岳陽樓記_語譯.txt", "09_岳陽樓記_難詞.json"),
    ("10_liuguo", "六國論", "10_六國論_原文.txt", "10_六國論_語譯.txt", "10_六國論_難詞.json"),
    ("11_tangshi", "唐詩三首", "11_唐詩三首_原文.txt", "11_唐詩三首_語譯.txt", "11_唐詩三首_難詞.json"),
    ("12_ci", "詞三首", "12_詞三首_原文.txt", "12_詞三首_語譯.txt", "12_詞三首_難詞.json"),
]
